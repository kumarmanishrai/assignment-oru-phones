          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                <a
                  href="#"
                  key={`services-link-${services.replace(/\s+/g, "-").toLowerCase()}`}
                  id={`services-link-${services.replace(/\s+/g, "-").toLowerCase()}`}
                  className="block text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 text-sm"
                >
                  {services}
                </a>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <a
                  href="#"
                  key={`category-link-${category_name.replace(/\s+/g, "-").toLowerCase()}`}
                  id={`category-link-${category_name.replace(/\s+/g, "-").toLowerCase()}`}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <a
                  href="#"
                  id={`accessories-link-${accessories_name.replace(/\s+/g, "-").toLowerCase()}`}
                  key={`accessories-link-${accessories_name.replace(/\s+/g, "-").toLowerCase()}`}
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300 text-sm"
                >
                  {accessories_name}
                </a>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <a
                  href="#"
                  id={`company-link-${company_link.replace(/\s+/g, "-").toLowerCase()}`}
                  key={`company-link-${company_link.replace(/\s+/g, "-").toLowerCase()}`}
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300 text-sm"
                >
                  {company_link}
                </a>
